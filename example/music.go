// Package musicsrepo is generated by needle v0.4.0-2-g049ac2e-dirty, DO NOT CHANGE.
package musicsrepo
...
type Musics interface {
	...
	InsertMusic(ctx context.Context, args *InsertMusicArgs, options ...Option) (sql.Result, error)
...
func (s musics) GetMusics(ctx context.Context, options ...Option) ([]Music, error) {
	...
	rst, err := s.cache.Get(ctx, args.Key(), ([]Music)(nil), time.Duration(5000000000),
		func() (interface{}, error) {
			return s.getMusics(ctx, exec, args)
		}, nocache)
	return rst.([]Music), err
...
func (s musics) GetMusicByAuthorAndName(ctx context.Context, args *GetMusicByAuthorAndNameArgs, options ...Option) (*Music, error) {
	...
	rst, err := s.cache.Get(ctx, args.Key(), (*Music)(nil), time.Duration(300000000000),
		func() (interface{}, error) {
			return s.getMusicByAuthorAndName(ctx, exec, args)
		}, nocache)
...
func (s musics) InsertMusic(ctx context.Context, args *InsertMusicArgs, options ...Option) (sql.Result, error) {
	sql := InsertMusicStmt
	exec := s.getExec(options)
	arglist, inlens := args.arglist()
	sql, err := replaceInCond(sql, inlens...)
